...
// New imports for icons for management screens
import androidx.compose.material.icons.filled.Category
import androidx.compose.material.icons.filled.LocationOn
import androidx.compose.material3.IconButton

// New imports for filtering UI
...
fun ExpenseTrackerApp(expenseViewModel: ExpenseViewModel) {
    ...
    val totalMonthlyExpenses by expenseViewModel.totalMonthlyExpenses.collectAsState(initial = 0.0)
    ...
    Scaffold(
        ...
        Column(
            ...
            ExpenseSummaryCard(totalAmount = totalMonthlyExpenses ?: 0.0)
                ...
                Row(
                    ...
                    dateOptions.forEach { option ->
                        Button(
                            ...
                            // Only enable the button if its filter is not already active
                            enabled = when (option) {
                                "ThisMonth" -> {
                ...
                TextButton(
                    onClick = {
                        dateRangePickerState.selectedStartDateMillis?.let { startDate ->
                            ...
                            expenseViewModel.setCustomDateRangeFilter(startDate, endDate)
                        } ?: run {
...
fun CategoryFilterDropdown(
    ...
    ExposedDropdownMenuBox(
        ...
        TextField(
            ...
            // UPDATED: Use the new menuAnchor overload
            modifier = Modifier
                .menuAnchor(MenuAnchorType.PrimaryNotEditable, true) // Changed here
                .fillMaxWidth()
        )
        ExposedDropdownMenu(
            expanded = expanded,
...
// Helper functions for date calculations (can be moved to a utility file if preferred)
